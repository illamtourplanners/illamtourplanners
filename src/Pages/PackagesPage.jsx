      ...
      <section className="py-20 bg-[url('https://images.unsplash.com/photo-1539635278303-d4002c07eae3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80')] bg-cover bg-fixed bg-center relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href='/contact'><button className="px-8 py-3 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
              Book a Consultation
            </button></a>
 ...
 <section className={`py-20 ${darkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
  <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {[
        `"Vaidehi Holidays gave me an authentic taste of Kerala’s rich culture — truly an unforgettable experience."`,
        `"It wasn’t just a trip — it was a deep dive into Kerala’s soul. Vaidehi Holidays made it magical."`,
        `"The cultural immersion was beyond anything I expected. Vaidehi Holidays showed me the real Kerala."`
      ].map((quote, index) => (
        <div
          key={index}
          className={`p-8 rounded-2xl transition-all duration-300 hover:shadow-lg ${
            darkMode ? 'bg-gray-750 hover:bg-gray-700' : 'bg-white hover:bg-white'
          }`}
        >
          ...
          <div className="flex items-center">
            <div>
              <h4 className="font-semibold">Unnikrishnan</h4>
