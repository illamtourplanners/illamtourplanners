...
const AddressPage = () => {
  ...
  const removePerson = (index) => {
    if (index === 0) return; // Prevent deleting the primary traveler
              ...
              <div className="flex justify-between relative">
                ...
                {[1, 2].map((s) => (
                  <div key={s} className="flex flex-col items-center z-10">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${s === 1
                    ...
                    <span className={`mt-2 text-xs font-medium ${s === 1 ? "text-gray-800" : "text-gray-500"
                      }`}>
                      {s === 1 ? "Details" : "Payment"}
                    </span>
                  </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border ${(index === 0 && errors.primaryName) ||
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border ${errors.primaryPhone ? "border-red-500" : "border-gray-200"
                              } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                          />
                          {errors.primaryPhone && (
                        ...
                        {index === 0 && (
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 border ${errors.primaryEmail ? "border-red-500" : "border-gray-200"
                                } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                            />
                            {errors.primaryEmail && (
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            {["Male", "Female", "Other"].map((gender) => (
                              <button
                                ...
                                className={`py-2.5 px-3 rounded-lg text-center text-sm font-medium ${person.gender === gender
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className={`w-full px-4 py-3 border ${errors.primaryPickupPoint ? "border-red-500" : "border-gray-200"
                              } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`w-full px-4 py-3 border ${(index === 0 && errors.primaryAadhaar) ||
